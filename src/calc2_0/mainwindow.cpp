  ...
  if (!err) {
    ...
    switch (err) {
      case 1:
        ...
        break;
      case 2:
        QMessageBox::critical(this, "WARNING", "INCORRECT_BRACKETS");
        break;
      case 3:
        QMessageBox::critical(this, "WARNING", "END_STACK");
        break;
      case 4:
        QMessageBox::critical(this, "WARNING", "END_BRACKETS");
        break;
      case 5:
        QMessageBox::critical(this, "WARNING", "END_EQUAL");
        break;
      case 6:
        QMessageBox::critical(this, "WARNING", "END_LESS");
        break;
      case 7:
        QMessageBox::critical(this, "WARNING", "DIVISION_BY_ZERO");
        break;
      case 8:
        QMessageBox::critical(this, "WARNING", "NOT_EQUAL");
        break;
      case 9:
        QMessageBox::critical(this, "WARNING", "ERROR");
        break;
      case 10:
        QMessageBox::critical(this, "WARNING", "ERR_X_VALUE");
        break;
    }
